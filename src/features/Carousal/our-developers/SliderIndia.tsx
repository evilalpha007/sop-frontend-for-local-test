...
interface ISliderProps {
  slidesData: TDeveloperItemSlides[] | null | undefined; // Array of developer items or null/undefined
}

const SliderIndia = ({ slidesData: developers }: ISliderProps) => {
                    ...
                    {developer ? (
                      <>
                        {isActive && (
                          <>
                            <Link
                              href={`/in/our-developers/${developer.slug}`}
...
export default memo(SliderIndia);
