...
import { getDeveloperPropertyList } from "@/api/get-developer-property-list";
...
const DeveloperPropertyList = async ({
  apiQuery,
  className,
  fragmentOnly,
}: IPropertyListProps) => {
  const { properties } = await getDeveloperPropertyList(apiQuery);
  const content = (
    <div className="mx-auto max-w-[1097px]">
      ...
      <div className="mt-7 flex items-center justify-center">
        ...
        >
          <Link
            href={
              apiQuery?.country && apiQuery?.country !== "uae"
...
export default DeveloperPropertyList;
