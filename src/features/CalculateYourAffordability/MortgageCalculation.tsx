      ...
      <div className="items-center# flex w-full flex-col justify-center bg-[#232122] px-6 py-8">
        <div className="mx-auto mb-5 w-full max-w-[700px] text-center">
          ...
          <Typography className="text-center text-sm font-light text-theme-off-white">
            Want to buy property in Dubai? It should be a seamless experience.
            Let our mortgage partners guide you to the best rates in the UAE
        ...
        <div className="mt-8 flex flex-col place-content-center gap-10 lg:flex-row">
          <div className="w-full space-y-10 lg:w-1/2">
            <div className="flex flex-row items-center justify-between gap-3">
              ...
              />
              <div className="mt-[30px] flex items-center justify-end gap-3">
                <OutlineButton
                  className="border-theme-off-white !py-1.5 !text-2xl"
            ...
            <div>
              <label
                className={cn(
                  "mb-1 inline-block text-[8px] font-medium text-theme-light-golden sm:mb-2 sm:text-sm",
                )}
              >
                Advance Payment (%)
              </label>
              <div className="ml-3">
                <Range
                  ...
                  renderThumb={({ props }) => (
                    <div
                      {...props}
                      className="mx-[33px] flex h-4 w-fit min-w-[22px] items-center justify-center overflow-hidden bg-[#D9D9D9] px-0.5 text-[8px] text-theme-black"
                    >
                      {advancePayment}%
                    </div>
                  )}
            ...
            <div className="flex w-full flex-row items-center justify-between gap-3">
              ...
              <div className="mt-[30px] flex w-fit items-center justify-end gap-3">
                <OutlineButton
                  className="border-theme-off-white !py-1.5 !text-2xl"
          ...
          <div className="w-full lg:w-1/2">
            ...
            <PrimaryButton className="w-full">Apply for Mortgage</PrimaryButton>
          </div>
        </div>
      </div>
    </Section.Container>
