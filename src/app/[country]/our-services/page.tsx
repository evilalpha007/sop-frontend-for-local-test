...
const WhoWeArePage = async ({ params }: IWhoWeArePageProps) => {
  const data = await getSeoMeta({
    url: `https://www.silveroakglobal.com/${params.country}/our-services`,
  });
    ...
    <>
      ...
      <Section className="overflow-x-hidden">
        <Section.Container>
          ...
          <OurServices country={params.country} />
        </Section.Container>
      </Section>
