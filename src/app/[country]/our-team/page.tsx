...
import TeamMemberSlider from "@/features/Carousal/TeamMemberSlider";
...
const OurTeamPage = ({ searchParams, params }: IOurTeamPageProps) => {
  // console.log("🚀 ~ OurTeamPage ~ searchParams:", searchParams)
  ...
  return (
    <div key={searchParamsString}>
          ...
          <div className="md:w-2/3">
            ...
            <div className="space-y-4 text-sm text-gray-300">
              <p className="text-gray-300">
                Silver Oak Properties, founded by Devang Janani, is a premier
      ...
      <TeamExperts
        apiQuery={{
          country: searchParams?.country
            ? getParsedValue(searchParams?.country)
            : params?.country,
      ...
      {/* <ExpertList className="mt-20">
        <ExpertList.Title
          className=""
          title="OPERATIONS & MARKETING TEAM MEMBERS (DUBAI)"
        />
        <ExpertList.Filters />
