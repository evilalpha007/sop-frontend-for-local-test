...
import { FaPhone, FaCheck, FaStar, FaChild, FaClock, FaHeadset, FaMapMarkerAlt, FaEnvelope, FaUser } from "react-icons/fa";
...
const ProductDetailsPage = async ({ params }: any) => {
  ...
  return (
    <>
      ...
      <Section.Container className="bg-gradient-to-r from-[#1a1a1a] to-[#2d2d2d] py-6 border-y border-theme-light-golden border-opacity-20">
        <Typography as="h2" className="mb-6 text-center text-2xl font-light text-theme-light-golden md:text-3xl">
      ...
      <Section className="py-8">
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="bg-theme-gray bg-opacity-50 rounded-xl p-6 border border-theme-light-golden border-opacity-20">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div className="p-4">
                  <Typography as="p" className="text-2xl font-bold text-theme-light-golden">
                    {bedrooms}
                  </Typography>
            ...
            {!!listingDetailsData?.shouldVisible && (
              <div id="ListingDetails" className="bg-theme-gray bg-opacity-30 rounded-xl p-6 border border-theme-light-golden border-opacity-20">
                <ArrowListTable>
                  ...
                  <ArrowListTable.ListRowsGroup maxColumns="2">
                    <div className="w-full overflow-x-auto">
                      <div className="w-full min-w-[300px]">
                        <ArrowListTable.ListRowsGroup.ListRows data={listingDetailsData?.listingDataPart1} />
                      </div>
                    </div>
                    <div className="w-full overflow-x-auto">
                      <div className="w-full min-w-[300px]">
                        <ArrowListTable.ListRowsGroup.ListRows data={listingDetailsData?.listingDataPart2} />
                      </div>
                    </div>
            ...
            <Hr className="border-b-theme-light-golden border-opacity-30" withSectionContainer />

            {/* Enhanced Description */}
            {!!description && (
              <div id="Description" className="bg-theme-gray bg-opacity-30 rounded-xl p-8 border border-theme-light-golden border-opacity-20">
                <Section.Container>
                  <div className="text-center mb-8">
                    <Typography as="h2" className="text-3xl font-light text-theme-light-golden mb-4">
                      Property Description
                    </Typography>
                    <div className="w-20 h-0.5 bg-theme-light-golden bg-opacity-50 mx-auto"></div>
                  </div>

                  <div className="prose prose-invert max-w-none">
                    <Typography as="div" className="text-sm font-light leading-7 text-theme-off-white text-opacity-90 lg:text-[15px] md:leading-[32px]">
            ...
            {!!propertyData?.plan_section?.is_plan_section && (
              <>
                <Hr className="border-b-theme-light-golden border-opacity-30" withSectionContainer />
                <div id="FloorPlan" className="bg-theme-gray bg-opacity-30 rounded-xl p-6 border border-theme-light-golden border-opacity-20">
            ...
            {!!floorPlanDetailsData?.shouldVisible && (
              <>
                <Hr className="border-b-theme-light-golden border-opacity-30" withSectionContainer />
                <div className="bg-theme-gray bg-opacity-30 rounded-xl p-6 border border-theme-light-golden border-opacity-20">
                  <ArrowListTable>
                    <ArrowListTable.Title
                      title={propertyData?.floor_plan_details_section?.floor_plan_title ?? "Explore the Floor Plan"}
                    />
                    <ArrowListTable.Description
                      description={propertyData?.floor_plan_details_section?.floor_plan_subtitle ?? "A detailed look at the layout and space distribution"}
                    />
            ...
            {!!propertyData?.["360_viewport_section"]?.is_360_viewport_section && (
              <>
                <Hr className="border-b-theme-light-golden border-opacity-30" withSectionContainer />
                <div id="Viewport" className="bg-theme-gray bg-opacity-30 rounded-xl p-6 border border-theme-light-golden border-opacity-20">
            ...
            {
              <div id="FeaturesAmenities" className="bg-theme-gray bg-opacity-30 rounded-xl p-6 border border-theme-light-golden border-opacity-20">
                <ArrowListTable>
                  ...
                  <ArrowListTable.ListRowsGroup maxColumns="3">
                    <ArrowListTable.ListRowsGroup.ListRows data={featureAmenitiesSectionData?.part1Data} />
                    <ArrowListTable.ListRowsGroup.ListRows data={featureAmenitiesSectionData?.part2Data} />
                    <ArrowListTable.ListRowsGroup.ListRows data={featureAmenitiesSectionData?.part3Data} />
                  </ArrowListTable.ListRowsGroup>
                </ArrowListTable>
              </div>
            }
            ...
            {!!highlightsSectionData?.shouldVisible && (
              <>
                ...
                <div className="bg-theme-gray bg-opacity-30 rounded-xl p-6 border border-theme-light-golden border-opacity-20">
                  <ArrowListTable>
                    <ArrowListTable.Title title={propertyData?.highlights_section?.highlight_title} />
                    <ArrowListTable.Description description={propertyData?.highlights_section?.highlight_description} />

                    <ArrowListTable.ListRowsGroup maxColumns="2" gap="none">
                      <ArrowListTable.ListRowsGroup.ListRows data={highlightsSectionData?.highlightsTable1} header="Size" />
                      <ArrowListTable.ListRowsGroup.ListRows data={highlightsSectionData?.highlightsTable2} header="Size" />
                    </ArrowListTable.ListRowsGroup>
                  </ArrowListTable>
                </div>
              </>
            ...
            {!!location_section?.is_location_section && (
              <>
                <Hr className="border-b-theme-light-golden border-opacity-30" withSectionContainer />
                <div id="Location" className="bg-theme-gray bg-opacity-30 rounded-xl p-6 border border-theme-light-golden border-opacity-20">
                  <LocationList
            ...
            {dld_section?.is_dld_section && (
              <>
                ...
                <Section.Container>
                  <div
                    id="DLDPermitNumber"
                    className="flex flex-col items-center justify-between gap-6 bg-gradient-to-r from-theme-gray to-theme-dark-gray bg-opacity-50 rounded-xl px-10 py-10 md:flex-row border border-theme-light-golden border-opacity-20"
                  >
                    <div className="w-full lg:w-2/3">
                      <Typography as="h2" className="mb-[23px] text-center text-xl font-light leading-normal text-theme-light-golden md:text-start md:text-2xl lg:text-[32px]">
                    ...
                    <div className="flex w-full flex-col items-center justify-between gap-3 lg:w-2/3 lg:flex-row">
                      ...
                      {propertyData?.dld_section?.dld_qr_code && propertyData?.dld_section?.dld_qr_number && (
                        <Typography as="p" className="text-[22px] font-light leading-10 text-theme-off-white">
                          OR
                        </Typography>
                      )}

                      {propertyData?.dld_section?.dld_qr_number && (
                        <Typography as="p" className="text-[22px] font-light leading-10 text-theme-light-golden font-mono bg-theme-dark-gray bg-opacity-50 px-4 py-2 rounded-lg">
                          {propertyData?.dld_section?.dld_qr_number}
                        </Typography>
                      )}
                    </div>
            ...
            {!!video_section?.is_video_section && (
              <>
                ...
                <Section.Container>
                  <div
                    id="NowInYoutube"
                    className="flex w-full flex-col items-center gap-x-16 p-[50px] lg:flex-row bg-theme-gray bg-opacity-30 rounded-xl border border-theme-light-golden border-opacity-20"
                  >
                    <div className="flex-col items-start justify-center text-center lg:flex-[45%] lg:text-start">
                      ...
                      <Typography as="p" className="mb-[37px] pr-2.5 text-sm font-light text-theme-off-white md:text-xl lg:mt-10">
                        {parse(video_section?.video_description ?? "")}
                      </Typography>

                      <Button className="hidden items-center gap-3.5 border border-theme-light-golden px-[35px] py-3.5 text-xl font-normal text-white lg:flex hover:bg-theme-light-golden hover:bg-opacity-10 transition-colors">
                        <NextImage
                    ...
                    <div className="w-full lg:flex-[45%]">
                      ...
                      <PrimaryButton asChild className="mt-[10px] w-full lg:hidden rounded-lg py-3.5">
                        <Link href={video_section?.video_button_link ?? "#"} target="_blank">
                          {video_section?.video_button_text}
                        </Link>
                      </PrimaryButton>
                    </div>
            ...
            <Section.Container>
              <div
                id="BookYourViewing"
                className="flex w-full flex-col items-center gap-10 rounded-xl border border-solid border-theme-green-gray border-opacity-30 bg-gradient-to-br from-theme-gray to-theme-dark-gray bg-opacity-50 px-5 py-5 md:px-[80px] md:py-[60px] lg:flex-row backdrop-blur-sm"
              >
                <div className="w-full max-w-full flex-1 lg:max-w-[460px]">
                  <ExpertCard
                    id={1}
                    image={propertyData?.contact_form_section?.property_contact_member_image || "/images/logo/primary-logo.svg"}
                    alt="expert"
                    name={propertyData?.contact_form_section?.property_contact_member_name}
                    designation={propertyData?.contact_form_section?.property_contact_member_specialized}
                    experience={propertyData?.contact_form_section?.property_contact_member_experience}
                    languages={
                      propertyData?.contact_form_section?.property_contact_member_language
                        ? Array.isArray(propertyData.contact_form_section.property_contact_member_language)
                          ? propertyData.contact_form_section.property_contact_member_language.join(", ")
                          : (() => {
                              try {
                                const parsed = JSON.parse(propertyData.contact_form_section.property_contact_member_language);
                                return Array.isArray(parsed) ? parsed.join(", ") : propertyData.contact_form_section.property_contact_member_language;
                              } catch {
                                return propertyData.contact_form_section.property_contact_member_language;
                              }
                            })()
                        : ""
                    }
                ...
                <BookingForm country={country} slug={params?.slug} id={propertyData?.id} />
              </div>
            </Section.Container>
            ...
            {developer_section?.is_developer_section && (
              <>
                <Hr className="border-b-theme-light-golden border-opacity-30" withSectionContainer />
                <div id="DubaiMarina" className="bg-theme-gray bg-opacity-30 rounded-xl p-6 border border-theme-light-golden border-opacity-20">
            ...
            <div id="FrequentlyAskedQuestions" className="bg-theme-gray bg-opacity-30 rounded-xl p-6 border border-theme-light-golden border-opacity-20">
              <Section.Container>
                <div className="text-center mb-8">
                  <Typography as="h2" className="text-[20px] font-medium text-theme-off-white sm:text-[32px] mb-4">
                    Frequently Asked Questions
                  </Typography>
                  <div className="w-16 h-0.5 bg-theme-light-golden bg-opacity-50 mx-auto"></div>
                </div>
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    {data?.map((item: any) => (
                      <Accordion key={item?.id} title={item?.question ?? ""}>
                        <div className="bg-theme-light-golden bg-opacity-10 px-4 py-3.5 text-[12px] font-light leading-[18px] sm:px-7 sm:py-5 sm:text-lg sm:leading-6 rounded-b-lg border border-theme-light-golden border-opacity-20 border-t-0">
                          {item?.answer}
                        </div>
                      </Accordion>
                    ))}
